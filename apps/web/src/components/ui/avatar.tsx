...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "group/avatar relative flex size-9 shrink-0 select-none overflow-hidden rounded-md data-[size=lg]:size-10 data-[size=sm]:size-6",
        className,
      )}
      {...props}
    />
...
function AvatarFallback({
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        "flex size-full items-center justify-center rounded-md bg-input/10 text-muted-foreground text-sm group-data-[size=sm]/avatar:text-xs",
        className,
      )}
      {...props}
    />
